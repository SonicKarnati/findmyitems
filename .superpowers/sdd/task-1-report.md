...
- Gather-only coverage uses a real planner result with an inventory-craftable stick child and table-required pickaxe root, asserting visible status and required materials.
