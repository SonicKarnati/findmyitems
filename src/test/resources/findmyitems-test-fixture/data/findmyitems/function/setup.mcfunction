...
execute positioned ~2 ~ ~2 unless entity @e[type=minecraft:marker,tag=findmyitems_fixture,distance=..0.1] if block ~ ~ ~ minecraft:air run summon minecraft:marker ~ ~ ~ {Tags:["findmyitems_fixture"]}
...
execute positioned ~4 ~ ~2 unless entity @e[type=minecraft:marker,tag=findmyitems_fixture,distance=..0.1] if block ~ ~ ~ minecraft:air run summon minecraft:marker ~ ~ ~ {Tags:["findmyitems_fixture"]}
execute positioned ~4 ~ ~2 if block ~ ~ ~ minecraft:air run setblock ~ ~ ~ minecraft:chest[facing=north]
execute positioned ~4 ~ ~1 unless entity @e[type=minecraft:marker,tag=findmyitems_fixture,distance=..0.1] if block ~ ~ ~ minecraft:air run summon minecraft:marker ~ ~ ~ {Tags:["findmyitems_fixture"]}
...
execute positioned ~6 ~ ~2 unless entity @e[type=minecraft:marker,tag=findmyitems_fixture,distance=..0.1] if block ~ ~ ~ minecraft:air run summon minecraft:marker ~ ~ ~ {Tags:["findmyitems_fixture"]}
execute positioned ~6 ~ ~2 if block ~ ~ ~ minecraft:air run setblock ~ ~ ~ minecraft:chest[facing=north]
execute positioned ~5 ~ ~1 unless entity @e[type=minecraft:marker,tag=findmyitems_fixture,distance=..0.1] if block ~ ~ ~ minecraft:air run summon minecraft:marker ~ ~ ~ {Tags:["findmyitems_fixture"]}
execute positioned ~5 ~ ~1 if block ~ ~ ~ minecraft:air run setblock ~ ~ ~ minecraft:stone
execute positioned ~7 ~ ~1 unless entity @e[type=minecraft:marker,tag=findmyitems_fixture,distance=..0.1] if block ~ ~ ~ minecraft:air run summon minecraft:marker ~ ~ ~ {Tags:["findmyitems_fixture"]}
...
execute positioned ~8 ~ ~2 unless entity @e[type=minecraft:marker,tag=findmyitems_fixture,distance=..0.1] if block ~ ~ ~ minecraft:air run summon minecraft:marker ~ ~ ~ {Tags:["findmyitems_fixture"]}
execute positioned ~8 ~ ~2 if block ~ ~ ~ minecraft:air run setblock ~ ~ ~ minecraft:chest[facing=north]
execute positioned ~9 ~ ~2 unless entity @e[type=minecraft:marker,tag=findmyitems_fixture,distance=..0.1] if block ~ ~ ~ minecraft:air run summon minecraft:marker ~ ~ ~ {Tags:["findmyitems_fixture"]}
...
execute positioned ~12 ~ ~2 unless entity @e[type=minecraft:marker,tag=findmyitems_fixture,distance=..0.1] if block ~ ~ ~ minecraft:air run summon minecraft:marker ~ ~ ~ {Tags:["findmyitems_fixture"]}
execute positioned ~12 ~ ~2 if block ~ ~ ~ minecraft:air run setblock ~ ~ ~ minecraft:chest[facing=north]
execute positioned ~12 ~1 ~2 unless entity @e[type=minecraft:marker,tag=findmyitems_fixture,distance=..0.1] if block ~ ~ ~ minecraft:air run summon minecraft:marker ~ ~ ~ {Tags:["findmyitems_fixture"]}
...
execute positioned ~14 ~ ~2 unless entity @e[type=minecraft:marker,tag=findmyitems_fixture,distance=..0.1] if block ~ ~ ~ minecraft:air run summon minecraft:marker ~ ~ ~ {Tags:["findmyitems_fixture"]}
execute positioned ~14 ~ ~2 if block ~ ~ ~ minecraft:air run setblock ~ ~ ~ minecraft:crafting_table

execute positioned ~16 ~ ~2 unless entity @e[type=minecraft:marker,tag=findmyitems_fixture,distance=..0.1] if block ~ ~ ~ minecraft:air run summon minecraft:marker ~ ~ ~ {Tags:["findmyitems_fixture"]}
...
execute positioned ~30 ~ ~2 unless entity @e[type=minecraft:marker,tag=findmyitems_fixture,distance=..0.1] if block ~ ~ ~ minecraft:air run summon minecraft:marker ~ ~ ~ {Tags:["findmyitems_fixture"]}
