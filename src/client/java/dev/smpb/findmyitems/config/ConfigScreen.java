...
public final class ConfigScreen {
    ...
    public static Screen create(Screen parent, ModConfig config, Path configPath) {
        var builder = ConfigBuilder.create()
                ...
                .setTitle(Component.translatable("screen.findmyitems.config.title"))
                .setSavingRunnable(() -> config.save(configPath));

        var general = builder.getOrCreateCategory(Component.translatable("screen.findmyitems.config.category.general"));

        general.addEntry(builder.entryBuilder()
                .startIntSlider(
                        Component.translatable("screen.findmyitems.config.rescan_interval"),
                ...
                .setTooltip(Component.translatable("screen.findmyitems.config.rescan_interval.tooltip"))
                .build());
