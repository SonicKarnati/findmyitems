    ...
    private static RenderType createSeeThroughLines() {
        try {
            var pipeline = RenderPipeline.builder(RenderPipelines.LINES_SNIPPET)
                    .withLocation(Identifier.fromNamespaceAndPath("findmyitems", "pipeline/see_through_lines"))
                    .withDepthStencilState(new DepthStencilState(CompareOp.ALWAYS_PASS, false))
                    .build();

            return RenderType.create("findmyitems_see_through_lines", RenderSetup.builder(pipeline)
