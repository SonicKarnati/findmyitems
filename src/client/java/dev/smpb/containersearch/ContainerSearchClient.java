...
import dev.smpb.containersearch.debug.TestbedCommand;
...
import dev.smpb.containersearch.search.InventorySearchController;
...
public final class ContainerSearchClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        var configPath = configDir.resolve("container-search.json");
        ...
        if (!activeWorld()) {
            if (client.player != null) {
                client.player.sendOverlayMessage(
                        Component.translatable("message.container-search.singleplayer_only"));
            }
            return;
        }
